...
<html>
  ...
  <body className="dark:bg-black">
    ...
    <div className="relative w-full">
      <div className="absolute top-0 overflow-hidden w-full h-full flex z-10">
        <img src="/static/img/john-price-RAZQiZOX3mU-unsplash.jpg" className="object-cover scale-110 self-center translate-y-2" />
      </div>
